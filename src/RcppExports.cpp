...
RcppExport SEXP _splatrees_find_not_nan(SEXP infieldSEXP, SEXP filteringSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _splatrees_list_mean(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _splatrees_list_qtile(SEXP xSEXP, SEXP qSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::field<arma::mat>& >::type x(xSEXP);
...
RcppExport SEXP _splatrees_kthresholds(SEXP xSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _splatrees_col_to_string(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _splatrees_part_axis_parallel_lmt(SEXP coordsSEXP, SEXP thresholdsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type coords(coordsSEXP);
...
RcppExport SEXP _splatrees_multires_graph(SEXP parchimatSEXP, SEXP non_empty_blocksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _splatrees_number_revalue(SEXP original_matSEXP, SEXP from_valSEXP, SEXP to_valSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// spamtree_sample
Eigen::VectorXd spamtree_sample(const arma::mat& coords, const arma::uvec& blocking, const arma::field<arma::uvec>& parents, const arma::vec& block_names, const arma::field<arma::uvec>& indexing, const arma::vec& theta, const arma::mat& Dmat, int num_threads, bool cache, bool verbose, bool debug);
RcppExport SEXP _splatrees_spamtree_sample(SEXP coordsSEXP, SEXP blockingSEXP, SEXP parentsSEXP, SEXP block_namesSEXP, SEXP indexingSEXP, SEXP thetaSEXP, SEXP DmatSEXP, SEXP num_threadsSEXP, SEXP cacheSEXP, SEXP verboseSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type coords(coordsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(spamtree_sample(coords, blocking, parents, block_names, indexing, theta, Dmat, num_threads, cache, verbose, debug));
    return rcpp_result_gen;
END_RCPP
}
// vec_to_symmat
arma::mat vec_to_symmat(const arma::vec& x);
RcppExport SEXP _splatrees_vec_to_symmat(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _splatrees_xCovHUV_base(SEXP hSEXP, SEXP uSEXP, SEXP vSEXP, SEXP paramsSEXP, SEXP qSEXP, SEXP dimSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _splatrees_xCovHUV(SEXP coordsSEXP, SEXP ind1SEXP, SEXP ind2SEXP, SEXP cparamsSEXP, SEXP DmatSEXP, SEXP sameSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type coords(coordsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_splatrees_find_not_nan", (DL_FUNC) &_splatrees_find_not_nan, 2},
    {"_splatrees_list_mean", (DL_FUNC) &_splatrees_list_mean, 1},
    {"_splatrees_list_qtile", (DL_FUNC) &_splatrees_list_qtile, 2},
    {"_splatrees_mesh_multires_mcmc", (DL_FUNC) &_splatrees_mesh_multires_mcmc, 32},
    {"_splatrees_kthresholds", (DL_FUNC) &_splatrees_kthresholds, 2},
    {"_splatrees_col_to_string", (DL_FUNC) &_splatrees_col_to_string, 1},
    {"_splatrees_part_axis_parallel_lmt", (DL_FUNC) &_splatrees_part_axis_parallel_lmt, 2},
    {"_splatrees_multires_graph", (DL_FUNC) &_splatrees_multires_graph, 2},
    {"_splatrees_number_revalue", (DL_FUNC) &_splatrees_number_revalue, 3},
    {"_splatrees_spamtree_sample", (DL_FUNC) &_splatrees_spamtree_sample, 11},
    {"_splatrees_vec_to_symmat", (DL_FUNC) &_splatrees_vec_to_symmat, 1},
    {"_splatrees_xCovHUV_base", (DL_FUNC) &_splatrees_xCovHUV_base, 6},
    {"_splatrees_xCovHUV", (DL_FUNC) &_splatrees_xCovHUV, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_splatrees(DllInfo *dll) {
